...
* Draw the AWS architecture diagram.
* Integrate, assemble, and run local testing of the application using Docker Compose.
* Use Terraform to write IaC code for rapid networking prototyping of infrastructure architectures on AWS.
...
* Successfully integrated and ran local testing of the application on the development machine using Docker Compose.
* Successfully ran rapid prototyping of infrastructure.
