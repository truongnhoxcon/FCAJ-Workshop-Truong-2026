...
* Thực hiện tích hợp, ráp nối và chạy thử nghiệm cục bộ ứng dụng thông qua Docker Compose.
* Sử dụng Terraform để viết code IaC thử nghiệm nhanh tính tương thích của các mô hình kiến trúc hạ tầng trên AWS.
...
* Tích hợp và chạy thử nghiệm ứng dụng thành công trên máy phát triển qua Docker Compose.
* Thử nghiệm nhanh hạ tầng thành công.
