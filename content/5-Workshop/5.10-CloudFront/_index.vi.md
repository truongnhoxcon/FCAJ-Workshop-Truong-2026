...
![Khởi tạo Distribution - Chọn gói cước](/images/5-Workshop/5.10-CloudFront/cf-origin-1.png)
...
![Khởi tạo Distribution - Get started](/images/5-Workshop/5.10-CloudFront/cf-origin-2.png)
...
![Khởi tạo Distribution - Specify origin](/images/5-Workshop/5.10-CloudFront/cf-origin-3.png)
...
![Copy policy từ CloudFront](/images/5-Workshop/5.10-CloudFront/cf-policy-1.png)

![Copy policy từ CloudFront](/images/5-Workshop/5.10-CloudFront/copy-policy.png)

4. Chọn tab Permissions ➔ cuộn xuống Bucket policy ➔ nhấp vào Edit ➔ dán chính sách JSON đã sao chép ➔ nhấp vào Save change.


![Dán Bucket Policy trong S3 Permissions](/images/5-Workshop/5.10-CloudFront/cf-policy-2.png)

![Origins tab list](/images/5-Workshop/5.10-CloudFront/cf-alb-1.png)
...
![Khởi tạo ALB Backend Origin](/images/5-Workshop/5.10-CloudFront/cf-alb-2.png)
...
![Khởi tạo ALB Backend Origin](/images/5-Workshop/5.10-CloudFront/cf-behavior-1.png)
...
![Cấu hình Behavior cho Path /api/*](/images/5-Workshop/5.10-CloudFront/cf-behavior-2.png)
...
* **Tạo Behavior 1 (Dành cho `/api/*` REST API)**:
  ...
  ![Error Pages tab](/images/5-Workshop/5.10-CloudFront/cf-error-1.png)
...
* **Tạo Behavior 2 (Dành cho `/ws/*` WebSockets)**:
  ...
  ![Cấu hình Custom Error Response 403](/images/5-Workshop/5.10-CloudFront/cf-error-2.png)
...
![Cấu hình Custom Error Response 404](/images/5-Workshop/5.10-CloudFront/cf-error-3.png)
...
2. Thiết lập lỗi 403:
   ...
   ![Danh sách Custom Error Responses](/images/5-Workshop/5.10-CloudFront/cf-error-4.png)
...
3. Tiếp tục bấm **Create custom error response** để thiết lập lỗi 404:
   ...
   ![General Settings Edit click](/images/5-Workshop/5.10-CloudFront/cf-general-1.png)

##### 4. Cấu hình Root Object & IPv6
1. Di chuyển sang tab **General** ➔ Tại mục **Settings**, bấm nút **Edit**.

![Cấu hình Default Root Object index.html](/images/5-Workshop/5.10-CloudFront/cf-general-2.png)
...
![Địa chỉ Domain name CloudFront hoàn thành](/images/5-Workshop/5.10-CloudFront/cf-domain.png)
