...
![Create DB Subnet Group](/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-subnet-group-create.png)
...
![Create Parameter Group](/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-subnet-group-details.png)
...
![Edit Parameter Group](/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-parameter-group-create.png)

![Enforce SSL encryption](/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-parameter-group-edit.png)
...
![Database creation Engine Options](/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/db-create-engine.png)

- **Availability and durability**: **Multi-AZ DB instance**

![Database Settings & Credentials](/images/5-Workshop/5.3-Data-Storage/5.3.2-RDS-Database/2az.png)
